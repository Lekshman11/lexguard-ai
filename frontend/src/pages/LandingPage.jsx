...
export default function LandingPage() {
  return (
    <PageTransition className="space-y-24 pb-24">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8" id="features">
        <SectionHeading
      ...
      <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8" id="workflow">
        <SectionHeading
              ...
              <div className="rounded-[28px] border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-7 text-white/70">Query intake, interpretation, risk class, and next actions in one polished response flow.</p>
                  </div>
                </div>
              </div>
              <div className="rounded-[28px] border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-7 text-white/70">The UI reinforces the value of the backend instead of competing with it.</p>
                  </div>
                </div>
              </div>
            </div>
